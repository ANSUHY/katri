			...
			$.ajax({
				...
				, success 	: function(result) {
					...
					if (result.resultCode === 200) {
						...
						} else if(sLoginResCode === "fail_overFailCnt") {//------------- 5회 입력 실패로 잠금 상태
	...
	<div id="cont" class="cont-login">
		<section class="login-wr">
			...
			<article class="inner">
				...
				<form method="post" id="frm_loginIdData" name="frm_loginIdData" >
					<input type="hidden" id="tagetLoginId"  name="loginId" value=""/>
				</form>

				<form id="frm_login" name="frm_login" method="post" onSubmit="return false;">
					<input type="text" 		id="loginId"	name="loginId"	placeholder="아이디를 입력해주세요." 		class="loginInput inp-id" title="아이디"/>
					<input type="password" 	id="loginPwd"	name="loginPwd" placeholder="비밀번호를 입력해주세요." 	class="loginInput inp-pw" title="password"/>
