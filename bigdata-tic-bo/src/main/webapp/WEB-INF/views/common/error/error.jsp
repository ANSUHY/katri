			...
			<div class="contentsInner">
				<!--error st-->
					<div class="error_frame">
						<div class="errorimg"><img src="/images/common/error_ico.png" alt=""></div>
						...
						<button style="cursor:pointer;" class="button_default maingo" onclick="fn_beforePage();">전페이지로 이동</button>
					</div>
				<!--error ed-->
			</div>
		</div>
