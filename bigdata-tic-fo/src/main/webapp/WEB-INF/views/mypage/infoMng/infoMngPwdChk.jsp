...
<script type="text/javascript">
	 ...
	 * 설   명 : 비밀번호 확인 후 호출
	 */
	function fn_infoMngPwdChkAfter() {
			...
			<c:choose>
				<c:when test="${userInfoData.userTyCd eq USER_TYPE_INST_MASTER }">
					<ul class="sub-tabs grid3">
						<li class="on"><a href="/mypage/infoMng/infoMngPwdChk">기관정보 수정</a></li>
						<li class=""><a href="/mypage/accountMng/accountMngList">기관계정 관리</a></li>
						<li class=""><a href="/mypage/inquiry/inquiryList">1:1문의</a></li>
					</ul>
				</c:when>
				<c:when test="${userInfoData.userTyCd eq USER_TYPE_ENT_MASTER }">
					<ul class="sub-tabs grid3">
						<li class="on"><a href="/mypage/infoMng/infoMngPwdChk">기업정보 수정</a></li>
						<li class=""><a href="/mypage/accountMng/accountMngList">기업계정 관리</a></li>
						<li class=""><a href="/mypage/inquiry/inquiryList">1:1문의</a></li>
					</ul>
				</c:when>
				<c:otherwise>
					<ul class="sub-tabs grid2">
						<li class="on"><a href="/mypage/infoMng/infoMngPwdChk">회원정보 수정</a></li>
						<li class=""><a href="/mypage/inquiry/inquiryList">1:1문의</a></li>
					</ul>
				</c:otherwise>
			</c:choose>
