...
public class MyDataStatSelectReq {
	...
	/* (조회시 필요) [성적서] > [월별 TOP10품목별 성적서 정보]_기관품목코드 */
	private String rankInstPdctgCd;

	/* (조회시 필요) [성적서] > [월별 TOP10품목별 성적서 정보]_기관품목명 */
	private String rankInstPdctgNm;

	/* (조회시 필요) [성적서] > [월별 TOP10품목별 성적서 정보]_품목 정보들 */
	private List<MyDataStatSelectReq> rankRprtPdctgInfoList;
	...
	/* (조회시 필요) [성적서] > [월별 TOP10항목별 성적서 정보]_항목 정보들 */
