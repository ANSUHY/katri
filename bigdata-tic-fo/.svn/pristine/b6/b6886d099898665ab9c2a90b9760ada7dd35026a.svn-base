...
public class MyDataStatSelectRes {
	...
	//[인증] -> 월별 법정기준 인증추이_안전확인 어린이
	private List<MyDataStatSelectRes> safetyConfirmList;

	//[인증] -> 월별 법정기준 인증추이_안전인증 어린이
	private List<MyDataStatSelectRes> safetyCertList;

	//[인증] -> 월별 법정기준 인증추이_안전확인 전안
	private List<MyDataStatSelectRes> safetyConfirmList2;

	//[인증] -> 월별 법정기준 인증추이_안전인증 전안
	private List<MyDataStatSelectRes> safetyCertList2;
	...
	// [성적서] > [월별 TO_p10기업 성적서]
	private Integer cnt20;

	// [성적서] > [월별 TO_p10기업 성적서]
	private Integer cnt30;

	// [성적서] > [월별 TO_p10기업 성적서]
	private Integer cnt40;
