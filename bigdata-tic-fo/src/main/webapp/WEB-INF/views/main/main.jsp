...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$(".board-tabs > li").on('click', function(event){
			...
			//클릭된 li에 active 클래스 붙이기
			$('.board-tabs > li').eq(index).addClass('active');
			...
			if(sortCode == 1) {
				...
				$("#nttTyCd").val('${POST_TYPE_CD_FAQ}');
			} else if(sortCode == 3) {
				$("#nttTyCd").val('${POST_TYPE_CD_ARCHIVE}');
			}
			...
			<div class="swiper-wrapper">
					...
					<div class="swiper-slide">
						...
						<c:choose>
							<c:when test="${mainVisualList.linkTyCd eq 'new' && mainVisualList.linkUrlAddr ne ''}">
								<img src="${mainVisualList.pcImgStrgFileFullPathAddr}" class="pc-block" onerror="this.src='/asset/images/main-mv-default.png'" onclick="javascript:newin=window.open('about:blank');newin.location.href='${mainVisualList.linkUrlAddr}'" style="cursor:pointer;" alt="메인비주얼이미지">
								<img src="${mainVisualList.mobileImgStrgFileFullPathAddr}" class="mo-block" onerror="this.src='/asset/images/main-mv-m-default.png'" onclick="javascript:newin=window.open('about:blank');newin.location.href='${mainVisualList.linkUrlAddr}'" style="cursor:pointer;" alt="메인비주얼이미지">
							</c:when>
							<c:when test="${mainVisualList.linkTyCd eq 'self' && mainVisualList.linkUrlAddr ne ''}">
									<img src="${mainVisualList.pcImgStrgFileFullPathAddr}" class="pc-block" onerror="this.src='/asset/images/main-mv-default.png'" onclick="javascript:location.href='${mainVisualList.linkUrlAddr}'" style="cursor:pointer;" alt="메인비주얼이미지">
									<img src="${mainVisualList.mobileImgStrgFileFullPathAddr}" class="mo-block" onerror="this.src='/asset/images/main-mv-m-default.png'" onclick="javascript:location.href='${mainVisualList.linkUrlAddr}'"style="cursor:pointer;" alt="메인비주얼이미지">
							</c:when>
							<c:otherwise>
								<img src="${mainVisualList.pcImgStrgFileFullPathAddr}" class="pc-block" onerror="this.src='/asset/images/main-mv-default.png'" alt="메인비주얼이미지">
								<img src="${mainVisualList.mobileImgStrgFileFullPathAddr}" class="mo-block" onerror="this.src='/asset/images/main-mv-m-default.png'" alt="메인비주얼이미지">
							</c:otherwise>
						</c:choose>
					</div>
				</c:forEach>
				<c:if test="${empty mainVisualList}">
					<div class="swiper-slide">
						...
						<img src="/asset/images/main-mv-default.png" class="pc-block"><img src="/asset/images/main-mv-m-default.png" class="mo-block" alt="메인비주얼이미지">
					</div>
				</c:if>
				<%---------- --%>
...
<div id="container">
	...
	<div id="cont" class="main-c">
		<div class="report-wr">
			<h3 class="tit">
				<span><c:choose>
						<c:when test="${ mainData.month eq 1}"> 12월 인증현황
						</c:when>
						<c:otherwise> ${ mainData.month-1 }월 인증현황
						</c:otherwise>
					  </c:choose>
				</span>
			</h3>
			<h4 class="tit">
				시험인증 빅데이터 플랫폼에서 제공하는<br class="mo-block"> 전월 인증현황입니다.
			</h4>
			<div class="report-inr">
				<div class="grid">
					<h5 class="stit">TOP10 법정인증 품목(중분류 기준)</h5>
			...
			<div class="banner-cont">
				...
				<div class="banner-swiper swiper">
							...
							<c:choose>
								<c:when test="${popUpZoneList.linkTyCd eq 'new' && popUpZoneList.linkUrlAddr ne ''}">
									<a href="${popUpZoneList.linkUrlAddr}" target="_blank">
										<img src="${popUpZoneList.pcImgStrgFileFullPathAddr}" class="pc-block" onerror="this.src='/asset/images/main-banner-default.png'" alt="팝업존이미지">
										<img src="${popUpZoneList.mobileImgStrgFileFullPathAddr}" class="mo-block" onerror="this.src='/asset/images/main-banner-m-default.png'" alt="팝업존이미지">
									</a>
								</c:when>
					...
					<c:if test="${empty popUpZoneList}">
						<div class="swiper-slide">
					 		<img src="/asset/images/main-banner-default.png" class="pc-block"><img src="/asset/images/main-banner-m-default.png" class="mo-block" alt="팝업존이미지">
						</div>
					</c:if>
				<%-- --%>
		...
		<div class="community-wr">
			...
			<%-- board-tabs --%>
			<ol class="board-tabs">
				<li class="active" data-tab="board01" value="1"><span>공지사항</span></li>
				<li data-tab="board02" value="2"><span>FAQ</span></li>
				<li data-tab="board03" value="3"><span>자료실</span></li>
			</ol>
			<%--########### --%>
