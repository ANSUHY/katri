	...
	<div id="cont" class="cont-login">
		...
		<article class="info-rect email-chk-wr">
			<ul>
				<li>
					<label>아이디</label>
					<input type="text" name="userId" id="userId" class="engNumber" placeholder="아이디를 입력하세요" title="아이디">
				</li>
			</ul>
		</article>
		...
		<article class="info-rect lock-prove-wr master">
			<ul>
				<li>
					...
					<input type="text" name="emlAddrId" id="emlAddrId" class="inp-half" title="이메일아이디">
					...
					<input type="text" name="emailAddr" id="emailAddr" class="inp-readonly" readonly title="이메일주소">
