...
<form name="schmLayoutSearchFrm" id="schmLayoutSearchFrm" onsubmit="return false;">
	<div class="hd-wr">
		...
		<!-- 검색 -->
		<input type="text" id="schmUnifiedSearchKeyword" name="unifiedSearchKeyword" onkeypress="fn_schmUnifiedSearchEnter()" placeholder="검색어를 입력해 주세요" class="inp-sch" title="검색">
		<input type="button" onclick="fn_schmGoUnifiedSearch()" class="btn-input-sch" value="검색">
	</div>
</form>
<div class="inner">
	<dl>
