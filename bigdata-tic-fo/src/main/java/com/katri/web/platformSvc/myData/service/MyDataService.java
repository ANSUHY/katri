...
public class MyDataService {
	...
	*****************************************************/
	public Integer getMyCertCnt(MyDataSelectReq myCertSelectReq) throws Exception{
		...
		// [[2]]. ========= 개수 조회
		myCertSelectReq.setBrno(SessionUtil.getLoginBrno());				//사업자번호
		myCertSelectReq.setEntGrpMngNo(getDefaultEntGrpMngNo(SessionUtil.getLoginEntGrpMngNo()));	//기업그룹관리번호
...
//		}
		...
		newMyDataSaveReq.setEntGrpMngNoDefault(getDefaultEntGrpMngNo(SessionUtil.getLoginEntGrpMngNo()));	//기업그룹관리번호
