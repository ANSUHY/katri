	...
	<div id="container">
		...
		<form id="frm_userMdfcn" name="frm_userMdfcn" method="post">
			...
			<div id="cont" class="cont-mypage join-insert mypage-modify"><!--회원정보관리 클래스 추가-->
				...
				<input type="text" readonly value="기업(일반)회원" class="inp-readonly wd100">
				...
				<input type="text" readonly value="${userInfoData.entNm}/${userInfoData.entGrpNm}" placeholder="" class="inp-readonly wd100">
