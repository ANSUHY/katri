...
@ApiModel(description = "회원 현황 관리 조회 Response")
public class UserSelectRes extends Common {
...
//	private String mdfrId;
	...
	/** 로그 접속 시간 */
	private String lgnHistCrtDt;

	/** 로그 접속 아이디 */
	private String lgnHistCrtrId;
	/** ====================== //TB_LGN_HIST [[로그인 이력]] ====================== */
	/** ======================================================================== */

	/** ====================================================================== */
	/** ====================== TB_TRMS_AGRE_HIST [[약관 동의 이력]] ====================== */
	/** 약관일련번호 */
	private Integer trmsSn;

	/** 약관 동의 일시 */
	private String trmsAgreHistCrtDt;
	...
	/** 파일 정보_file */
	private List<FileDto> lstUserFile;
	...
	/** 관심 키워드 정보 목록 */
	private List<UserPrdtSelectRes> lstUserPrdt;
