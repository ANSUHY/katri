	...
	*****************************************************/
	public String makeMailBody(HttpServletRequest request, MailMakeBodyDto mailMakeBodyDto) throws Exception {
		...
		if(request == null) {
			...
			String mRealPath = request.getSession().getServletContext().getRealPath("/");   // localPath  :  "C:\\DirBahkTaeu\\workspace-bigdata-tic-2years"
			// String mRealPath = "C:\\DirBahkTaeu\\workspace-bigdata-tic-2years";
