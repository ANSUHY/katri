...
public class UserFindService {
	...
	*****************************************************/
	 ...
	 * @throws Exception
	*****************************************************/
	public UserFindSaveRes chgUserPwd(HttpSession session, UserFindSaveReq userFindSaveReq) throws Exception {
		...
		String targetUserId = userFindSaveReq.getTargetUserId();
		...
		// 변경 타겟 아이디
		userFindSelectReq.setTargetUserId( sessionTargetUserId );

		// 변경 타겟 아이디 세팅
		userFindSaveReq.setTargetUserId(sessionTargetUserId);
		...
		// 새 비밀번호 암호화
		String encChgUserPwd = StringUtil.nvl(EncryptUtil.encryptSha256( userFindSaveReq.getChgUserPwd(), sessionTargetUserId ));
		...
		if( userFindSaveReq.getChgUserPwd().contains( sessionTargetUserId ) ) {
		...
		/** ======================= [3]. 반환값 셋팅 ===================== */
		userFindSaveRes.setUserId( sessionTargetUserId );
		/** ============================ [3] ========================= */
