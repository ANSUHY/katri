...
<%@ taglib prefix="cm"		uri="/WEB-INF/tlds" %>
	...
	<script>
		...
		/*
		 * 함수명 : fn_mainVisualSwiperSet
		 * 설   명 : swiper 설정
		 */
		function fn_mainVisualSwiperSet() {
		...
		function fn_pcVisualShow() {
			...
			// 2. PC 비주얼 목록 조회
			fn_mainVisualPreviewList('pc');

		}

		/*
		 * 함수명 : fn_mobileVisualShow
		 * 설   명 : Mobile 비주얼 목록 조회
		 */
		function fn_mobileVisualShow() {
			...
			// 2. Mobile 비주얼 목록 조회
			fn_mainVisualPreviewList('mobile');

		}

		/*
		 * 함수명 : fn_mainVisualPreviewList
		 * 설   명 : 사용중인 비주얼 목록 조회
		 */
		function fn_mainVisualPreviewList( type ) {
			...
			$.ajax({
				...
				, success 	: function(jsonData, textStatus, jqXHR) {
					...
					if(jsonData.resultCode === 200){
						...
						// 3. 조회 > 데이터 출력
						fn_mainVisualPreviewListHtml( jsonData.data, type );
		...
		/*
		 * 함수명 : fn_mainVisualPreviewListHtml
		 * 설   명 : 사용중인 비주얼 목록 HTML 출력
		 */
		function fn_mainVisualPreviewListHtml( data, type ) {
	...
	<div id="pop-wrap">
		...
		<h1 class="pop-tit">메인 비주얼 미리보기</h1>

		<div class="pop-contnet">

			<div class="div-tab">
				<ul>
					<li id="tabPc" class="on">	<a href="javascript:void(0);" onclick="fn_pcVisualShow();">PC</a></li>
					<li id="tabMobile">			<a href="javascript:void(0);" onclick="fn_mobileVisualShow();">Mobile</a></li>
				</ul>
			</div>
