	...
	*/
	function fn_userInfoMdfcnValidation() {
		...
		if($.trim($("#userDeptNm").val()) == "") {
			alert("<spring:message code='result-message.messages.common.message.required.data2' arguments='소속부서'/>"); // '{0}를(을) 입력해주세요.'
			$("#userDeptNm").focus();
			isValid = false;
			return false;
		}
	...
	<div id="container">
		...
		<form id="frm_userMdfcn" name="frm_userMdfcn" method="post">
			...
			<div id="cont" class="cont-mypage join-insert mypage-modify"><!--회원정보관리 클래스 추가-->
				...
				<input type="text" readonly value="기관(마스터)회원" class="inp-readonly wd100">

				<h4 class="tit"><span>기관명</span></h4>
				<input type="text" readonly value="${userInfoData.instNm}" placeholder="" class="inp-readonly wd100">

				<h4 class="tit"><span>소속부서</span></h4>
				<input type="text" id="userDeptNm" name="userDeptNm" value="${userInfoData.userDeptNm}" class="wd100" maxlength="20" />
<!--
				<h4 class="tit"><span>직위</span></h4>
				<input type="text" value="OO직위" placeholder="" class="wd100">
 -->
				<h4 class="tit"><span>아이디</span></h4>
				<div class="input-wr">
					<input type="text" id="userId" name="targetUserId" value="${userInfoData.userId}" class="wd1335" readonly />
				</div>
				...
				<input type="text" id="userNm" value="${userInfoData.userNm}" class="wd100" readonly>
				...
				<input type="text" id="mblTelnoVal" name="mblTelnoVal" value="${userInfoData.encptMblTelnoVal}" class="number wd100" maxlength="20" />
