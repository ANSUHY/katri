		...
		<div id="wrap">
			...
			<div id="cont" class="cont-myservice dtl-myservice qr-chk-wr qr-block">
				...
				<!--리스트-->
					...
					<c:if test="${empty certDataDetail.imgNameList}">
						<div class="svc-info-dtl" style="border-top:1px solid var(--black); display:block;">
							<div style="text-align:center; padding:80px 0px; border:1px solid #cecbcb; margin-top:10px; border-radius:10px;">
								해당 사진이 없습니다.
							</div>
						</div>
					</c:if>
